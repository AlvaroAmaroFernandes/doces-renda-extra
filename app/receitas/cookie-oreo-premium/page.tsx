...
export const metadata: Metadata = {
  title: "Cookie de Oreo Premium - Doces & Negócios",
  description: "Aprenda a fazer um delicioso Cookie de Oreo Premium para vender e lucrar",
}

export default function CookieOreoPremiumPage() {
  // URL da imagem externa
  const recipeImage = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-513gJzbaUr8Sghd1zkpZM9tGA1K86T.png"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mb-2">Cookie de Oreo Premium</h1>
          ...
          <Tabs defaultValue="ingredientes">
            ...
            <TabsContent value="ingredientes" className="space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>200g de biscoitos Oreo (aproximadamente 20 unidades), quebrados em pedaços</li>
                <li>100g de biscoitos Oreo triturados para decorar</li>
              </ul>
            </TabsContent>
            ...
            <TabsContent value="preparo" className="space-y-4">
              ...
              <ol className="list-decimal pl-5 space-y-4">
                ...
                <li>Incorpore o chocolate picado e os pedaços de Oreo à massa e misture levemente.</li>
                <li>Refrigere a massa por pelo menos 1 hora.</li>
                <li>Pré-aqueça o forno a 180°C e forre uma assadeira com papel manteiga.</li>
                <li>
                  Faça bolas com a massa (aproximadamente 2 colheres de sopa cada) e passe-as pelos biscoitos Oreo
                  triturados, pressionando levemente para aderir.
                </li>
                <li>
            ...
            <TabsContent value="dicas" className="space-y-4">
              ...
              <div className="space-y-4">
                <p>
                  O Cookie de Oreo Premium é um produto com alto potencial de lucro e grande apelo comercial. Aqui estão
                  algumas dicas para maximizar suas vendas:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong>Embalagem atrativa:</strong> Invista em embalagens que mostrem o produto e destaquem os
                    pedaços de Oreo visíveis no cookie.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Destaque o diferencial:</strong> Enfatize que são cookies artesanais com pedaços generosos
                    de Oreo original.
                  </li>
                  <li>
                    <strong>Fotos de qualidade:</strong> Invista em boas fotos que mostrem o cookie partido ao meio,
                    revelando os pedaços de Oreo no interior.
                  </li>
                  <li>
                    <strong>Variações:</strong> Considere criar variações como cookie de Oreo com chocolate branco ou
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between py-1 border-b">
                  <span>Calorias</span>
                  <span className="font-medium">340 kcal</span>
                </div>
                <div className="flex justify-between py-1 border-b">
                ...
                <div className="flex justify-between py-1">
                  <span>Fibras</span>
                  <span className="font-medium">1.8g</span>
                </div>
              </div>
