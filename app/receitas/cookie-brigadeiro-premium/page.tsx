...
export const metadata: Metadata = {
  title: "Cookie de Brigadeiro Premium - Doces & Negócios",
  description: "Aprenda a fazer um delicioso Cookie de Brigadeiro Premium para vender e lucrar",
}

export default function CookieBrigadeiroPremiumPage() {
  // URL da imagem externa
  const recipeImage = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-nKfG9iamdyFowIE9WcRFxLJUsPDhZM.png"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mb-2">Cookie de Brigadeiro Premium</h1>
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-muted text-muted-foreground px-2 py-1 rounded-md text-sm flex items-center">
            <Clock className="mr-1 h-4 w-4" /> 50 min
          </span>
          <span className="bg-muted text-muted-foreground px-2 py-1 rounded-md text-sm flex items-center">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-lg overflow-hidden mb-6 relative aspect-video">
            <img
              ...
              alt="Cookie de Brigadeiro Premium"
          ...
          <Tabs defaultValue="ingredientes">
            ...
            <TabsContent value="ingredientes" className="space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Para o recheio de brigadeiro:</li>
            ...
            <TabsContent value="preparo" className="space-y-4">
              ...
              <ol className="list-decimal pl-5 space-y-4">
                <li>
                  <strong>Prepare o brigadeiro:</strong> Em uma panela, misture o leite condensado, o cacau em pó e a
                  manteiga. Cozinhe em fogo baixo, mexendo sempre, até desgrudar do fundo da panela. Transfira para um
                  prato untado com manteiga e deixe esfriar completamente. Depois, faça pequenas bolinhas e leve à
                  geladeira.
                </li>
                <li>
                  <strong>Prepare a massa do cookie:</strong> Em uma tigela grande, bata a manteiga com os dois tipos de
                  açúcar até obter um creme claro e fofo.
                </li>
                <li>
                ...
                <li>
                  Em outra tigela, misture a farinha, o cacau em pó, o bicarbonato e o sal. Adicione aos poucos à
                  mistura de manteiga, mexendo delicadamente.
                </li>
                ...
                <li>
                  ...
                  achate na palma da mão, coloque uma bolinha de brigadeiro no centro e feche a massa ao redor do
                ...
                <li>Asse por 12-15 minutos, ou até que as bordas estejam firmes. O centro deve permanecer macio.</li>
                <li>
                  Deixe esfriar na assadeira por 5 minutos antes de transferir para uma grade para esfriar
                  completamente.
                </li>
                <li>Se desejar, decore com chocolate granulado enquanto os cookies ainda estiverem quentes.</li>
              </ol>
            </TabsContent>
            ...
            <TabsContent value="dicas" className="space-y-4">
              ...
              <div className="space-y-4">
                <p>
                  O Cookie de Brigadeiro Premium é um produto com alto potencial de lucro e grande apelo comercial. Aqui
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    ...
                    revelando o recheio cremoso de brigadeiro.
                  </li>
                  <li>
                    <strong>Variações:</strong> Considere criar variações como cookie de brigadeiro branco ou com
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link href="/receitas/cookie-nutella">
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1">
              <div className="relative h-48">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-bvC5cykEytESxFV08UAwsyCfK9PNRo.png"
                  alt="Cookie de Nutella"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-4">
                <h3 className="font-semibold">Cookie de Nutella</h3>
                <p className="text-sm text-muted-foreground mt-1">Biscoitos</p>
              </div>
            </div>
          </Link>
