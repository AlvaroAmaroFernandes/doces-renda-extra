        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="relative aspect-video w-full rounded-lg overflow-hidden my-6">
            <Image
              ...
              alt="Brownie de Nutella embalado para presente com laço e tag personalizada"
              fill
              className="object-cover"
            />
          </div>
          ...
          <div className="relative aspect-video w-full rounded-lg overflow-hidden my-6">
            <Image
              src="/placeholder.svg?height=400&width=800"
              alt="Processo de corte do brownie de Nutella mostrando o recheio cremoso"
              fill
              className="object-cover"
            />
          </div>
          ...
          <div className="relative aspect-video w-full rounded-lg overflow-hidden my-6">
            <Image
              src="/placeholder.svg?height=400&width=800"
              alt="Exemplo de feed do Instagram organizado com fotos de brownies de Nutella"
              fill
              className="object-cover"
            />
          </div>
          ...
          <h3>Legendas com gatilhos mentais (desejo, escassez, exclusividade)</h3>
          <p>Use técnicas de copywriting para criar legendas que convertam visualizações em vendas:</p>
          <ul>
            <li>
              <strong>Gatilho de escassez:</strong> "Última fornada da semana! Apenas 10 unidades disponíveis para
              entrega amanhã."
            </li>
            <li>
              <strong>Gatilho de urgência:</strong> "Promoção válida apenas hoje: na compra de 4 brownies, ganhe 1
              grátis!"
            </li>
            <li>
              <strong>Gatilho de exclusividade:</strong> "Edição limitada: Brownie de Nutella com ouro comestível.
              Apenas para os 20 primeiros pedidos."
            </li>
            <li>
              <strong>Gatilho de desejo:</strong> "Imagine morder este brownie e sentir o recheio cremoso de Nutella
              derretendo na sua boca..."
            </li>
            <li>
              <strong>Gatilho de prova social:</strong> "Mais de 100 caixas vendidas só nesta semana! Veja o que nossos
          ...
          <h2 id="variacoes-criativas" className="scroll-mt-20">
            Variações Criativas de Brownie com Nutella
          </h2>

          <h3>Brownie de Nutella com Ninho</h3>
          <p>
            Uma combinação que conquistou o paladar brasileiro, o brownie de Nutella com Leite Ninho une dois sabores
            nostálgicos em um só produto. Para criar esta versão:
          </p>
          <ul>
            <li>Adicione 100g de Leite Ninho em pó à massa base</li>
            <li>Crie camadas alternadas: massa, Nutella, massa com Ninho</li>
            <li>Finalize com uma cobertura mesclada de Nutella e creme de Leite Ninho</li>
          </ul>
          <p>
            Esta versão pode ser vendida com um valor 15-20% superior ao brownie tradicional de Nutella, devido ao apelo
            adicional do Leite Ninho.
          </p>

          <h3>Brownie de Nutella com morangos</h3>
          <p>
            A acidez dos morangos contrasta perfeitamente com a doçura da Nutella, criando uma experiência sensorial
            equilibrada. Para esta versão:
          </p>
          <ul>
            <li>Adicione morangos frescos fatiados entre as camadas de massa e Nutella</li>
            <li>Decore o topo com morangos frescos e um fio de Nutella derretida</li>
            <li>Opcionalmente, adicione raspas de limão à massa para realçar o sabor dos morangos</li>
          </ul>
          <p>
            Esta versão é perfeita para a primavera/verão e pode ser posicionada como uma opção mais leve e refrescante.
          </p>

          <h3>Mini brownies para festas e lembrancinhas</h3>
          <p>Versões miniatura são perfeitas para festas, degustações e presentes corporativos:</p>
          <ul>
            <li>Prepare a mesma receita, mas asse em formas de mini muffins</li>
            <li>Reduza o tempo de forno para 15-18 minutos</li>
            <li>Injete um pouco de Nutella no centro de cada mini brownie após assado</li>
            <li>Embale individualmente em papel celofane transparente com fita colorida</li>
            <li>Crie tags personalizadas para ocasiões especiais (aniversários, formaturas, etc.)</li>
          </ul>
          <p>
            Os mini brownies podem ser vendidos em caixas de 9, 12 ou 16 unidades, com preços entre R$3,00 e R$5,00 por
            unidade, dependendo da complexidade da decoração e embalagem.
          </p>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="font-bold mb-2">
                  <Link href="/receitas/brownie-doce-de-leite" className="hover:text-primary">
                    Brownie de Doce de Leite: Uma Combinação Irresistível
                  </Link>
                </h3>
                <p className="text-sm text-muted-foreground">
                  Descubra como fazer um brownie com camadas de doce de leite cremoso.
                </p>
              </div>
            </div>
          </div>
